...
public class ImageLoader : MonoBehaviour
{
    ...
    public Sprite SlideSprite9;
    public Sprite SlideSprite10;
    ...
    void Update()
    {
        ...
        switch (number)
        {
            ...
            case 8:
                ...
                break;
            case 9:
                this.transform.GetComponent<UnityEngine.UI.Image>().sprite = SlideSprite9;
                break; 
            case 10:
                this.transform.GetComponent<UnityEngine.UI.Image>().sprite = SlideSprite10;
                break;
            default:
                number=1;
                break;
